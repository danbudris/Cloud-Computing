...
Borg manages about 83% of entire set of mahcines that runs prod, non-prod task at the same time. prod is long running service that should never die such as google search, gmail, google doc.
